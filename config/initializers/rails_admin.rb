# RailsAdmin config file. Generated on October 04, 2013 15:38
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Lorious', 'Admin']
  ...
  # config.excluded_models = ['Appointment', 'Availability', 'Conversation', 'Expert', 'Invite', 'Message', 'Notification', 'Receipt', 'Review', 'SocialMedium', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Appointment', 'Availability', 'Conversation', 'Expert', 'Invite', 'Message', 'Notification', 'Receipt', 'Review', 'SocialMedium', 'User']
  ...
  #     configure :expert, :belongs_to_association 
  ...
  #     configure :expert_id, :integer         # Hidden 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your availability.rb model definition
  ...
  #     configure :id, :integer 
  #     configure :expert_id, :integer         # Hidden 
  #     configure :timespans, :text 
  #     configure :hourly_cost, :float 
  #     configure :timezone_in_minutes, :integer 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'Expert' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your expert.rb model definition

  #   # Found associations:

  #     configure :messages, :has_many_association 
  #     configure :receipts, :has_many_association 
  #     configure :reviews_made, :has_many_association 
  #     configure :reviews_received, :has_many_association 
  #     configure :appointments, :has_many_association 
  #     configure :social_media, :has_many_association 
  ...
  #     configure :availability, :has_one_association 
  ...
  #     configure :global, :boolean 
  #     configure :expires, :datetime 
  ...
  #     configure :sender, :polymorphic_association         # Hidden 
  #     configure :notified_object, :polymorphic_association         # Hidden 
  #     configure :receipts, :has_many_association 
  ...
  #     configure :reviewer, :belongs_to_association 
  #     configure :reviewed, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :reviewer_id, :integer         # Hidden 
  #     configure :reviewed_id, :integer         # Hidden 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your social_medium.rb model definition
